...
# Engine-backed datasets (mujoco/genesis) register a builder that raises a clear error only when
# instantiated without the optional dependency, so importing the package never requires them.
from . import droid, genesis_fluid, mujoco_physics, physics_iq, robot_toy  # noqa: F401
