...
#
#   SPLIT=train sbatch scripts/slurm_extract_v2d.sh   # 4000 clips (500 scenes x 8), seed 0
#   SPLIT=test  sbatch scripts/slurm_extract_v2d.sh   #  800 clips (100 scenes x 8), seed 2
